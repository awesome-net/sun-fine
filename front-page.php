<?php
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			<?php
				$pc_img = get_field('top_pc')['url'];
				$sp_img = get_field('top_sp')['url'];
				if (wp_is_mobile()) {
					$hero_img_url = $sp_img;
				}else{
					$hero_img_url = $pc_img;
			...
			?>
			<section class="top-hero" style="background-image:url('<?php echo $hero_img_url; ?>');">
				<div class="top-hero__cont">
					...
					<ul class="top-hero__info">
						...
						<li>
							<?php echo $hero_field_business_hours_title['label']; ?>
							･･<?php echo $hero_business_hours; ?>
						</li>
					</ul>
			...
			<section class="top-blog">
				...
				<div class="top-blog__more">
					<a href="<?php echo home_url('/repair/'); ?>" target="" class="top-blog__button-cont">もっとみる</a>
				</div>
			</section>
